...
public class PushdTest {
  ...
  @Test
  public void testPushCurrent() {
    arguments.add("dirA");
    pushd.execute(arguments, eh, validator, resource);
    arguments.clear();
    arguments.add("/dirB");
    pushd.execute(arguments, eh, validator, resource);
    dc.moveToDirectory(directoryC);
    String resDir = null;
    try {
      resDir = ds.pop();
