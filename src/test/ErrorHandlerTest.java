...
public class ErrorHandlerTest {
  ...
  public void testAddMessage() {
    errH.addMessage("added message");
    String result = errH.getErrorMessage(27);
    assertEquals("added message", result);
  }

  @Test
  public void testGetErrorMessage() {
    String result = errH.getErrorMessage(0);
    assertEquals("Undefined error", result);
  }
