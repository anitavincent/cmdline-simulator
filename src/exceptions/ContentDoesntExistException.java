...
public class ContentDoesntExistException extends Exception {
  /**
   * 
   */
  private static final long serialVersionUID = 4352400269023247620L;

  public ContentDoesntExistException(String message) {
    super(message);
  }
}
