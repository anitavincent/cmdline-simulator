...
public class InvalidDirectoryOrFileNameException extends Exception {
  /**
   * 
   */
  private static final long serialVersionUID = -6869237262850074038L;

  public InvalidDirectoryOrFileNameException(String message) {
    super(message);
  }
}
