...
/**
 * This singleton is the root directory for the file system.
 */
public class FileSystem extends Directory {
  ...
  /**
   * Returns the file system. Creates it if it does not already exist.
   * 
   * @return The file system.
   */
  public static FileSystem getSystem() {
    if (system == null) {
