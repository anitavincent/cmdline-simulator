 ...
 * 
 * 
 * Responsible for outputing messages to screen
 * 
 */
...
public class OutputToScreen {
  ...
  public OutputToScreen(Output output) {
    this.output = output;
  }
...

  {
    ...
    Output o = this.output;


    if (o.getStdOutput() != null)

    {

      System.out.println(o.consumeStdOutput());

    }

    if (o.getStdError() != null)

    {

      System.out.println(o.consumeStdError());
