...
public class ManTest {
  ...
  public void testInvalidCommand() {
    arguments.add("popipopipopopipo");
    man.execute(arguments, eh, validator, resource);
    result = out.consumeStdError();
    assertEquals(
        "Invalid argument. for command man, command -popipopipopopipo- does not exist",
        result);
  }
  ...
  public void testMan() {
    ...
    assertEquals("Print documentation for CMD", result);
  }
  ...
  public void testExit() {
    ...
    man.execute(arguments, eh, validator, resource);
    result = out.consumeStdOutput();
    assertEquals("Quit the program.", result);
  }
